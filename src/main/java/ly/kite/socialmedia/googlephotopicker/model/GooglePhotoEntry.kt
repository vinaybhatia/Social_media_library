...
/**
 * Created by ITDIVISION\maximess139 on 15/2/18.
 */
class GooglePhotoEntry : IPhotoEntry {
    var photoThumbUrl: String? = null

    /*public GooglePhotoEntry(String thumbURL, String fullURL, String datePhoto, String fileName) {
       this.photoThumbUrl = thumbURL;
       this.photoUrl = fullURL;
       this.photoId = datePhoto;
       this.photoFileName = fileName;
   }*/
    override var photoUrl: String? = null
    override var photoId: String? = null
